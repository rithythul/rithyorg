  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
      <section className="mb-12">
        ...
        <p className="text-lg">
          explore my writings below, or learn more <Link href="/about" className="text-blue-600 hover:underline">about me</Link>.
        </p>
      </section>

      {recentPosts.length > 0 && (
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-6">recent writing</h2>
